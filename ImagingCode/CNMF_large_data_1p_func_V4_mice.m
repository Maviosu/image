function CNMF_large_data_1p_func_V4_mice(input_path, gSiz_setting,ring_radius_setting)
%choose data
neuron = Sources2D(); 
...
% -------------------------      SPATIAL      -------------------------  %
gSig = 3;           % pixel, gaussian width of a gaussian kernel for filtering the data. 0 means no filtering (1/4 of the )
...
min_corr = 0.8;     % minimum local correlation for a seeding pixel; ori:0.8
min_pnr = 8;       % minimum peak-to-noise ratio for a seeding pixel;ori:8
